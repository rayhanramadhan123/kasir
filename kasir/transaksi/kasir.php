...
<body class="p-4 sm:p-8">
    <div class="container mx-auto max-w-5xl">
        <h1 class="text-4xl sm:text-5xl font-bold mb-8 text-center text-gray-800">Oke Shoes Kasir</h1>
    ...
    <div id="print-modal" class="modal">
        <div class="modal-content receipt">
            <h2 class="text-xl font-bold mb-4 text-center">Struk Pembelian</h2>
            <p class="text-sm mb-2 text-center">Website Kasir</p>
